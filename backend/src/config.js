...
const MINT_PRICE = 3.3; // Minting price per NFT. Rinkeby = ETH, Polygon = MATIC. CANNOT BE UPDATED!
const TOKENS_PER_MINT = 18; // maximum number of NFTs a user can mint in a single transaction. CANNOT BE UPDATED!
...
// ** OPTIONAL **
let CONTRACT_ADDRESS = "0xb693daF4DcbFA95A37833532B0AE4A525585b0d8"; // If you want to manually include it

// Generic Metadata is optional if you want to reveal your NFTs
const GENERIC = true; // Set to true if you want to upload generic metas and reveal the real NFTs in the future
const GENERIC_TITLE = CONTRACT_NAME; // Replace with what you want the generic titles to say if you want it to be different from the contract name.
const GENERIC_DESCRIPTION = "Middle finger coming up"; // Replace with what you want the generic descriptions to say.
