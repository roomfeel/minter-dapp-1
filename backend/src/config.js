...
const MINT_PRICE = .016; // Minting price per NFT. Rinkeby = ETH, Polygon = MATIC. CANNOT BE UPDATED!
const TOKENS_PER_MINT = 20; // maximum number of NFTs a user can mint in a single transaction. CANNOT BE UPDATED!

// REQUIRED CONTRACT DETAILS THAT CAN BE UPDATED LATER.
const PUBLIC_MINT_START_DATE = "2022-05-18T11:30:48+00:00"; // This is required. Eg: 2022-02-08T11:30:48+00:00
...
const BASE_URI = "ipfs://bafybeifue5za2z3ni7g75tzhskvjffh5tdkrg7st3iqbglxlfjvzgybteq/"; // only update if you want to manually set the base uri
