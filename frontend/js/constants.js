const contractAddress = "0x12Ce7944b246e18857Ad232Ab968347ecfA587ff"; //Replace with your own contract address
const chain = 'polygon'; // rinkeby or polygon

const welcome_h1 = "Welcome to the Middle Finger Club";
const welcome_h2 = "Connect to MetaMask to Get Started";
const welcome_p = 'Middle Finger Club is a collection of 5,000 pixel art NFTs created by Gri Mov. Follow our Twitter and scroll down for more details.';
...
const p_presale_coming_soon = "Fingers are almost ready to launch the NFT Collection. Follow the club for updates.";
